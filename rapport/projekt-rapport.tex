...
\begin{itemize}
  ...
  \item One ParseThread that reads the byte messages sent from the server and translates them into the correct game events.
...
there were network parts to fix or update. In the end we feel we have a good and robust solution.
