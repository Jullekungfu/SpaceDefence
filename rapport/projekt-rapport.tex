...
A player has a steady income. Furthermore, credits are earned for each creep killed. 
...
On the other hand, buying and sending creeps to the other players 
...
From within the client graphical user interface,  when a player starts a new game the server is started in conjunction with the said game.
